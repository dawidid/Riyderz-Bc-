...
client.on('ready', () => {
    ...
    client.user.setGame(`#Riyderz clan |$help `,"http://twitch.tv/y04zgamer")
...
client.on("message", message => {
      if (message.content === "$support") {
       const embed = new Discord.RichEmbed()
           .setColor("RANDOM")
           .setFooter('©Riyderz Bot')  
           .addField('❤سيرفر الدعم الفني', `  https://discord.gg/wYRywZ3  `)
...
client.on("message", message => {
    var prefix = "$";
       ...
       let embed = new Discord.RichEmbed()
        let args = message.content.split(' ').slice(1).join(' ');
    if(message.content.split(' ')[0] == prefix + 'bcv3') {
        if (!args[1]) {
...
let embed = new Discord.RichEmbed()
.addField('$bc', 'برودكاست للكل')
.addField('$obc', 'برودكاست للوفلاين')
.addField('$bcv2', 'برودكاست بشكل ثاني')
.addField('$bcv3', 'برودكاست بشكل ثالث')
